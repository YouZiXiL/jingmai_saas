...
class AliConfig
{
    private static ?AopCertClient $instance = null;
    public static string $appid = '2021003176656290'; // 第三方appid;
    public static string $templateId = "2021003189652073"; // 模板appid;
