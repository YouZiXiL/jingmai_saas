define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            $(document).on('click', '.btn-super_apply', function () {
                //Fast.config.openArea = ['300px','300px'];
                Fast.api.open('cash/servicelists/super_apply','申请提现');

            });
            // 初始化表格参数配置
            Table.api.init({
                extend: {
                    index_url: 'cash/servicelists/index' + location.search,
                    add_url: 'cash/servicelists/add',
                    edit_url: 'cash/servicelists/edit',
                    del_url: 'cash/servicelists/del',
                    multi_url: 'cash/servicelists/multi',
                    import_url: 'cash/servicelists/import',
