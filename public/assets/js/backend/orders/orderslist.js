            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function (value, row, index){
                                ...
                                if(row.order_status === '已取消' ||
                                    ...
                                    row.order_status === '下单失败' ||
                                    row.order_status === '7-运单已终止'){
                        ...
                        {field: 'pay_type', title: __('Pay_type'),  searchList: {"1":__('Pay_type 1'),"2":__('Pay_type 2'),"3":__('Pay_type 3'),"4":__('Pay_type 4')},visible: false},
